        ...
        <div class="col p-3">
            <div>
                <canvas class="position-absolute"
                    style="height: calc(100vh - 2rem); width: calc(100vh - 2rem);" v-bind:style="{transform: boardRotation}"></canvas>
                <img src="/images/monopoly.svg" style="height: calc(100vh - 2rem); width: calc(100vh - 2rem);" v-bind:style="{transform: boardRotation}"/>
            </div>
        </div>
